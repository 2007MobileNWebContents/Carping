...
public class PageInfo {
   ...
   public PageInfo(int currentPage, int noticeLimit, int pageLimit, int startPage, int endPage, int listCount,
         int maxPage) {
      super();
   ...
   public String toString() {
      return "PageInfo [currentPage=" + currentPage + ", noticeLimit=" + noticeLimit + ", pageLimit=" + pageLimit
