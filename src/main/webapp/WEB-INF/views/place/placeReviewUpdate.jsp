...
<body>
	...
	<form action="placeReviewUpdate.do" method="post" enctype="multipart/form-data">
    	...
    	<div class="container" style="font-family: 'Sunflower', sans-serif;">
			...
			<div class="container" style="font-family: 'Sunflower', sans-serif; font-weight:bold;">
				<div class="col-md-2"></div>
				<div class="col-md-8 vcenter">
				<label class="col-md-2 text-center vcenter" style="font-family: 'Sunflower', sans-serif; font-weight:bold;font-size: 1.5em;">제목</label><input type="text" name="prTitle"class="col-md-8 form-control align-self-center" value="${preview.prTitle }" style="font-family: 'Sunflower', sans-serif; font-weight:bold;width : 50%;">
				
				<div class="col-md-2" style="margin-top: 10px;">
					  <span class="star-input">
         <span class="input">
  	<c:if test="${preview.prScore eq 1 }">
  		<input type="radio" name="prScore" id="p1" value="1" checked="checked"><label for="p1">1</label>
  	...
  	<c:if test="${preview.prScore eq 2 }">
  		<input type="radio" name="prScore" id="p1" value="1"><label for="p1">1</label>
  		<input type="radio" name="prScore" id="p2" value="2" checked="checked"><label for="p2">2</label>
  		<input type="radio" name="prScore" id="p3" value="3"><label for="p3">3</label>
  		<input type="radio" name="prScore" id="p4" value="4"><label for="p4">4</label>
  		<input type="radio" name="prScore" id="p5" value="5"><label for="p5">5</label>
  	</c:if>
  	<c:if test="${preview.prScore eq 3 }">
  		<input type="radio" name="prScore" id="p1" value="1"><label for="p1">1</label>
  		<input type="radio" name="prScore" id="p2" value="2"><label for="p2">2</label>
  		<input type="radio" name="prScore" id="p3" value="3" checked="checked"><label for="p3">3</label>
  		<input type="radio" name="prScore" id="p4" value="4"><label for="p4">4</label>
  		<input type="radio" name="prScore" id="p5" value="5"><label for="p5">5</label>
  	</c:if>
  	<c:if test="${preview.prScore eq 4 }">
  		<input type="radio" name="prScore" id="p1" value="1"><label for="p1">1</label>
  		<input type="radio" name="prScore" id="p2" value="2"><label for="p2">2</label>
  		<input type="radio" name="prScore" id="p3" value="3"><label for="p3">3</label>
  		<input type="radio" name="prScore" id="p4" value="4" checked="checked"><label for="p4">4</label>
  		<input type="radio" name="prScore" id="p5" value="5"><label for="p5">5</label>
  	</c:if>
  	<c:if test="${preview.prScore eq 5 }">
  		<input type="radio" name="prScore" id="p1" value="1"><label for="p1">1</label>
  		<input type="radio" name="prScore" id="p2" value="2"><label for="p2">2</label>
  		<input type="radio" name="prScore" id="p3" value="3"><label for="p3">3</label>
  		<input type="radio" name="prScore" id="p4" value="4"><label for="p4">4</label>
  ...
  <output for="star-input"><input id="result" type="hidden" value="${preview.prScore}" style="border: none; margin-top: -500px; font-size: 1.4em;" size="1"></output>
			...
			<div class="container" style="font-family: 'Sunflower', sans-serif; font-weight:bold;">
				<div class="col-md-2"></div>
				<div class="col-md-8">
					<label class="col-md-2 text-center vcenter" style="font-family: 'Sunflower', sans-serif; font-weight:bold;font-size: 1.5em;">내용</label><textarea name="prContent" class="col-md-6 form-control" cols="5" rows="10" style="font-family: 'Sunflower', sans-serif; margin: 0px; width: 564px; height: 325px; resize: none;">${preview.prContent }</textarea>
				</div>
				<div class="col-md-2"></div>
			</div>
            <br>
