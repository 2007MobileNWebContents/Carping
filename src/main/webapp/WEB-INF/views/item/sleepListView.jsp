...
<body>
	...
	<div id="item_orderby">
		<a href="sleepListNew.do"><span id="orderby">최신순</span></a>| 
		<a href="sleepListLow.do"><span id="orderby">낮은가격순</span></a>| 
		<a href="sleepListHigh.do"><span id="orderby">높은가격순</span></a>
	</div>
		...
		<tr>
			<td colspan="6">
				<!-- 이전 --> <c:if test="${pi.currentPage <= 1 }">
					...
					<c:url var="before" value="sleepListView.do">
					...
					<c:url var="pagination" value="sleepListView.do">
					...
					<c:url var="after" value="sleepListView.do">
						<c:param name="page" value="${pi.currentPage + 1 }"></c:param>
					</c:url>
					<a href="${after }">▶</a>&nbsp;
				</c:if>
