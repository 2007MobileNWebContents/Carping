...
<body>
	...
	<div id="shopping" style="padding-left: 150px; width:100%">
		...
		<div id="item_category">
			<ul>
				...
				<li id="li_category">
					<span id="category">
						<a href="cookListView.do" style="color: green; font-weight: bold;">취사도구</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</span>
				</li>
				<li id="li_category">
					<span id="category">
	...
	<div id="item_orderby">
		<a href="cookListNew.do"><span id="orderby">최신순</span></a>| 
		<a href="cookListLow.do"><span id="orderby">낮은가격순</span></a>| 
		...
		<tr>
			<td colspan="6">
				<!-- 이전 --> <c:if test="${pi.currentPage <= 1 }">
					...
					<c:url var="before" value="cookListView.do">
					...
					<c:url var="pagination" value="cookListView.do">
					...
					<c:url var="after" value="cookListView.do">
						<c:param name="page" value="${pi.currentPage + 1 }"></c:param>
					</c:url>
					<a href="${after }">▶</a>&nbsp;
				</c:if>
