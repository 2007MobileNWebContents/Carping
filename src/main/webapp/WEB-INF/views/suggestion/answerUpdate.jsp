...
<body>
	...
	<section style="width:100%; height:800px;">
		...
		<div align="center">
			<h3 style="font-family: 'Sunflower', sans-serif; font-weight:bold;">건의사항 답변 수정</h3>
	...
	<form action="updateAnswer.do" method="post">
      ...
      <article>
            ...
            <div class="container" style="font-family: 'Sunflower', sans-serif;"></div>
               ...
               <div class="col-md-2"></div>
               <input type="submit" class="col-md-2 btn btn-info" style="font-family: 'Sunflower', sans-serif; font-weight:bold; height: 40px;" onclick="return Add();" value="답변 수정"> &nbsp;
               </div>
               <div class="col-md-2"></div>
               </div>
               </article>
