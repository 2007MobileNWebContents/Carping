...
<link rel="shortcut icon" type="image/x-icon"
	href="resources/images/carpingLogo.jpg">
...
<body>
			...
			<table class="table table-striped">
				<tr>
					<th
						...
						class="col-md-1 test-center">글번호</th>
					<th
						style="font-family: 'Sunflower', sans-serif; font-weight: bold;"
						class="col-md-5 test-center">제목</th>
					<th
						style="font-family: 'Sunflower', sans-serif; font-weight: bold;"
						class="col-md-1 test-center">작성자</th>
					<th
						style="font-family: 'Sunflower', sans-serif; font-weight: bold;"
						class="col-md-1 test-center">조회수</th>
					<th
						style="font-family: 'Sunflower', sans-serif; font-weight: bold;"
						class="col-md-2 test-center">작성일</th>
				</tr>
				<c:forEach items="${nList }" var="notice">
					<tr>
						<td
							style="font-family: 'Sunflower', sans-serif; font-weight: bold;">${notice.nKey }
						</td>
	...
	<c:if test="${loginUser.memberId == 'admin' }">
		<form action="noticeWriteView.do" method="get">
			...
			<table style="width: 100%; text-align: center; padding-top: 250px;">
			...
			<form action="noticeSearch.do" method="get">
				<div style="margin-left: 700px;">
					<select class="form-control col-sm-2"
						style="width: 120px; font-family: 'Sunflower', sans-serif; font-weight: bold;"
					...
					<input type="text" class="form-control col-sm-1"
						...
						style="font-family: 'Sunflower', sans-serif; font-weight: bold; width: 300px;"
						value="${search.searchValue }" required /> <input type="submit"
						class="btn btn-default col-sm-1"
						style="font-family: 'Sunflower', sans-serif; font-weight: bold; width: 80px;"
						value="검색" id="search" />
				</div>
			</form>
